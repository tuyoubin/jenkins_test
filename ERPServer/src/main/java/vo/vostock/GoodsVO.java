...
public class GoodsVO {
    ...
    // 商品值对象的创建方法
    public GoodsVO(String ID, String name, String type, int amount,  double purchasePrice,double recentPurchasePrice,
    ...
    public GoodsPO toPO(){
    	GoodsPO po = new GoodsPO(ID,name,type,amount,purchasePrice,recentPurchasePrice,
    			salePrice,recentPurchasePrice,warningValue,classID);
    	return po;
    }
}
