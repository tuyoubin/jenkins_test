 ...
 * 库存报损单
 */
public class StockLossNoteVO extends NoteVO{
	
	public StockLossNoteVO(String noteNumber, String userID,  int goodsListItemNum, String[] goodsIDList,
	...
	public StockLossNotePO toPO() {
		StockLossNotePO po = new StockLossNotePO(noteNumber, userID,  goodsListItemNum,
