...
public class DebitNoteSQLDeleter extends NoteSQLDeleter {
	...
	public DebitNoteSQLDeleter(String dataBaseName) {
		super(dataBaseName);
	...
	public boolean delete(NotePO notePO) {
		...
		try {
			//构建sql语句
			String sql = "delete from debit_note where note_number = ?";
			//设置预处理语句
			PreparedStatement stmt = connection.prepareStatement(sql);
			stmt.setString(SQLAttributeIndex.CompanyAccount_AccountName.index(), ((DebitNotePO)notePO).getNoteNumber());
