...
import vo.vostock.StockOverflowNoteVO;

/**
 * 库存报溢单
 */
public class StockOverflowNotePO extends NotePO implements Serializable{
	
	private static final long serialVersionUID = 1L;

	public StockOverflowNotePO(String noteNumber, String userID, int goodsListItemNum, String[] goodsIDList,
	...
	public StockOverflowNoteVO toVO() {
		StockOverflowNoteVO vo = new StockOverflowNoteVO(noteNumber, userID,  goodsListItemNum,
